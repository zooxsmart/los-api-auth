...
* GitHub Issues: <https://github.com/los/api-auth/issues>
...
* This library follows the **[PSR-12 coding standard][psr-12]**. Please
  ensure your code does, too.
* Please **write tests** for any new features you add.
* Please **ensure that tests pass** before submitting your pull request.
* **Use feature branches.** Please do not ask to pull from your master
  branch.
...
[github]: https://github.com/los/api-auth
[code of conduct]: CODE_OF_CONDUCT.md
[issues]: https://github.com/los/api-auth/issues
[pull requests]: https://github.com/los/api-auth/pulls
